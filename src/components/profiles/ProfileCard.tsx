          ...
          <div className="relative aspect-[3/4] overflow-hidden">
            ...
            {profile.isPinned && (
              <div className="absolute top-0 left-0 z-20 overflow-hidden w-24 h-24 pointer-events-none select-none">
                <div className="absolute top-0 left-0 bg-gradient-to-br from-[#ffd700] via-[#fff1a8] to-[#b8860b] text-black w-32 py-1.5 text-center font-black text-[11px] tracking-widest transform -rotate-45 -translate-x-10 translate-y-4 shadow-[0_4px_12px_rgba(0,0,0,0.6)] border-b border-yellow-200/50 flex items-center justify-center gap-1.5 uppercase">
                   {/* High-Contrast Shine Sweep */}
                   <div className="absolute inset-0 w-full h-full animate-[shimmer_1.5s_infinite] bg-gradient-to-r from-transparent via-white/60 to-transparent -translate-x-full" />
                   
                   <span className="text-sm drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]">👑</span>
                   <span className="font-black drop-shadow-[0_1px_1px_rgba(0,0,0,0.2)]">VIP</span>
                </div>
              </div>
            )}
